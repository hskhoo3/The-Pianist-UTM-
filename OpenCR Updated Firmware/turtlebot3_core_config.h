...
sensor_msgs::Range sonar_msg_front, sonar_msg_left, sonar_msg_right, sonar_msg_back;
ros::Publisher sonar_front_pub("sonar_front", &sonar_msg_front);
ros::Publisher sonar_left_pub("sonar_left", &sonar_msg_left);
ros::Publisher sonar_right_pub("sonar_right", &sonar_msg_right);
ros::Publisher sonar_back_pub("sonar_back", &sonar_msg_back);
