...
void loop()
{
  ...
  {
    publishSonarFrontMsg();
    publishSonarLeftMsg();
    publishSonarRightMsg();
    publishSonarBackMsg();
  ...
  // TODO
  // Update sonar data
   sensors.updateSonarFront(t);
   sensors.updateSonarLeft(t);
   sensors.updateSonarRight(t);
   sensors.updateSonarBack(t);
...
*******************************************************************************/
void publishSonarFrontMsg(void)
{
  sonar_msg_front.header.stamp = rosNow();
  sonar_msg_front.radiation_type = 0;
  sonar_msg_front.field_of_view = 0.2618;
  sonar_msg_front.min_range = 0.02;
  sonar_msg_front.max_range = 2.0;
  sonar_msg_front.range = sensors.getSonarDataFront();
  sonar_front_pub.publish(&sonar_msg_front);
}

void publishSonarLeftMsg(void)
{
  sonar_msg_left.header.stamp = rosNow();
  sonar_msg_left.radiation_type = 0;
  sonar_msg_left.field_of_view = 0.2618;
  sonar_msg_left.min_range = 0.02;
  sonar_msg_left.max_range = 2.0;
  sonar_msg_left.range = sensors.getSonarDataLeft();
  sonar_left_pub.publish(&sonar_msg_left);
}

void publishSonarRightMsg(void)
{
  sonar_msg_right.header.stamp = rosNow();
  sonar_msg_right.radiation_type = 0;
  sonar_msg_right.field_of_view = 0.2618;
  sonar_msg_right.min_range = 0.02;
  sonar_msg_right.max_range = 2.0;
  sonar_msg_right.range = sensors.getSonarDataRight();
  sonar_right_pub.publish(&sonar_msg_right);
}

void publishSonarBackMsg(void)
{
  sonar_msg_back.header.stamp = rosNow();
  sonar_msg_back.radiation_type = 0;
  sonar_msg_back.field_of_view = 0.2618;
  sonar_msg_back.min_range = 0.02;
  sonar_msg_back.max_range = 2.0;
  sonar_msg_back.range = sensors.getSonarDataBack();
  sonar_back_pub.publish(&sonar_msg_back);
}
